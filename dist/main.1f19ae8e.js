...
var div = dom.create("<div>new!</div>"); // console.log(div);
// dom.after(test,div)
// dom.before(test,div)
// dom.append(test,div)
// dom.wrap(test,div)
...
dom.class.add(test4, 'fl'); // console.log(dom.class.has(test5,"test55"));

var handleClick = function handleClick() {
  console.log("click!!!");
};

dom.class.on(test5, "click", handleClick); // dom.class.off(test5, "click", handleClick)
// console.log(dom.find("#test6_1")[0]);

var test6 = dom.find("#test6_2")[0]; // console.log(dom.find(".testFind", test6)[0]);
...
var t = dom.children(test07);
dom.each(t, function (n) {
